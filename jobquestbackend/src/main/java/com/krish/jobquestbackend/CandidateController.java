...
@CrossOrigin(origins = {"https://job-quest-client.vercel.app", "http://localhost:5173"})
public class CandidateController {
    ...
    public ResponseEntity<?> signup(@RequestBody Candidate candidate) {
        ...
        if (existingCandidate.isPresent()) {
            return new ResponseEntity<>(Map.of("error", "Email already taken"), HttpStatus.BAD_REQUEST);
        }
